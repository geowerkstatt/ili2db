...
public class MultiPolyline24Test extends ch.ehi.ili2db.MultiPolyline24Test {
    ...
    protected void assertMultiPolyline24_classa1_geomattr1(Statement stmt) throws Exception {
        ...
        while (rs.next()) {
            assertEquals("SRID=2056;MULTICURVE(COMPOUNDCURVE((480000.111 70000.111 4000.111,480000.222 70000.222 4000.222,480000.333 70000.333 4000.333)),COMPOUNDCURVE((480000.444 70000.444 4000.444,480000.555 70000.555 4000.555,480000.666 70000.66649 4000.6655)))", rs.getObject(1));
        }
    }
}
